...
./scripts/build.sh --prefix=%{buildroot} || { echo "Installation failed"; exit 1; }

%install
cmake --install build --prefix=%{buildroot}
install -m 755 %{buildroot}/build/filerix.node %{buildroot}/usr/lib64/node_modules/filerix/filerix.node
