...
BuildRequires:  git, curl, tar, unzip, cmake, make, gcc-c++, python, python-devel, systemd-devel
BuildRequires:  perl, perl-IPC-Cmd, perl-FindBin, perl-lib, perl-Pod-Usage
BuildRequires:  kernel-headers, kernel-devel, autoconf, autoconf-archive, automake, libtool, m4, pkg-config
