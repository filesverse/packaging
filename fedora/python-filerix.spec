...
BuildRequires:  git, curl, tar, unzip, cmake, make, gcc-c++, python, systemd-devel, perl, perl-IPC-Cmd, perl-FindBin, perl-lib, perl-Pod-Usage, kernel-headers, kernel-devel, autoconf
